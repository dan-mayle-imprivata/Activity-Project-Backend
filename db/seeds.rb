...
Activity.create(name: 'Griffith Park Hogback Trail to Hollywood Sign', duration: '3 hours', description: 'Well maintained trails. Lots of other hikers, awesome views.', user_id: 1, location_id: 1)
